...
#prism-library/prism/lib/colt.jar:prism-library/prism/lib/jhoafparser.jar:prism-library/prism/lib/pepa.zip:prism-library/prism/lib/prism.jar
javac -cp "./bin:prism-libary/*:/usr/lib/jvm/jdk1.8.0_181/jre/lib/jfxswt.jar:/usr/lib/jvm/jdk1.8.0_121/jre/lib/ext/jfxrt.jar" -d bin $(find ./src/* | grep .java)
...
java -cp "./bin:prism-library/prism/lib/colt.jar:prism-library/prism/lib/jhoafparser.jar:prism-library/prism/lib/pepa.zip:prism-library/prism/lib/prism.jar:/usr/lib/jvm/jdk1.8.0_181/jre/lib/jfxswt.jar:/usr/lib/jvm/jdk1.8.0_121/jre/lib/ext/jfxrt.jar" aCheck.CheckingDriver 
