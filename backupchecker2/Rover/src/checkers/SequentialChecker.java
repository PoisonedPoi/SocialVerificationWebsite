...
public class SequentialChecker {
	 ...
	 * Constructor
	 */
	public SequentialChecker(Interaction ia, HashMap<Microinteraction,String> Micro2File, HashMap<Microinteraction, HashMap<State, ModuleStatePair>> State2Label, HashMap<Microinteraction, HashMap<ModuleStatePair, State>> Label2State, Boolean isNonAssisted,
			BugTracker bt) {
		this.ia = ia;
