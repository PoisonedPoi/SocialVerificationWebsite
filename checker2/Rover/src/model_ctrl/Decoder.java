...
public class Decoder {
	...
	public Decoder(ModelFileChecker mc, Boolean isNonAssisted) {
		this.mc = mc;
		this.isNonAssisted = isNonAssisted;
	}
	
	public void readMicrointeraction(File file, String filename, Microinteraction micro) {
		readMicrointeractionHelper(file, filename, micro);
	}
	


	private void readMicrointeractionHelper(File file, String filename, Microinteraction micro) {
	...
	public void readSupremeXMLString(String xmlString, Interaction ia) {
		ia.initializeInteraction();
		//ia.setNonAssistedSwitch(this.isNonAssisted);
		Document doc = null;
		try{
