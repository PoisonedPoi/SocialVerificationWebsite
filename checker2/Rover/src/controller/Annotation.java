...
public class Annotation extends Text {
	...
	public Annotation(State state, Pane pane, ModelFileChecker mc) {
		obj = state;
		isCollapse = 0;
		objType = 0;
		text = formatStr(0);
	...
	public Annotation(ArrayList<Object> objects, String objType, Point xy, Pane pane, ModelFileChecker mc) {
	...
	public void addMC(ModelFileChecker mc) {
		this.mc = mc;
	}
